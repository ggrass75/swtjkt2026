...
description: "Building predictive maintenance with CoCo."
---
...
Problem Statement:
1. Predictive maintenance: Which assets are most likely to fail soon?
...
### Step 4: Problem 1
Step 4:
We selected predictive maintenance.

Inspect the synthetic manufacturing schema and identify:
- Asset master data
- Sensor readings
- Maintenance events
- Failure or downtime indicators
- The time grain and join keys

Do not assume column names. Inspect the actual schema first.

Then produce:
1. A concise description of the available maintenance signal.
2. The five most useful sensor or operating features.
3. The percentage of assets with usable history.
4. Any leakage, missing-data or timestamp risks.
5. A proposed asset-day analytical dataset for predicting a failure or maintenance event within the next seven days.
