...
description: "Demand and inventory: Which products are at risk of stockout or excess inventory?."
---
...
Problem Statement:
1. Demand and inventory: Which products are at risk of stockout or excess inventory?
...
### Step 4: Problem 2
Step 4:
We selected demand, inventory and supply-chain risk.

Inspect the synthetic manufacturing schema and identify:
- Customer orders or demand history
- Inventory balances
...
Then produce:
1. A concise description of the demand and inventory signal.
2. The five most useful forecasting or risk features.
3. A proposed 30-day demand forecast grain.
4. Stockout and excess-inventory definitions.
5. Any leakage, missing-data or timing risks.

Do not build the final forecast yet. First show the proposed logic and validation queries.
